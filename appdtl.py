...
bg_image_path = r"C:\Users\noels\Downloads\DTL-main\DTL-main\background image for.png"
...
def load_all_models():
    ...
    model_paths = {
        'dnn': r"C:\Users\noels\Downloads\DTL-main\DTL-main\dnn_base_model.h5",
        'xgb': r"C:\Users\noels\Downloads\DTL-main\DTL-main\xgb_base_model.joblib", 
        'meta': r"C:\Users\noels\Downloads\DTL-main\DTL-main\hybrid_meta_model.joblib",
        'scaler': r"C:\Users\noels\Downloads\DTL-main\DTL-main\target_scaler.joblib"
    }
    
    # Try original paths first, then current directory
    base_paths = [
        "C:\\Users\\DELL\\Desktop\\EL and DTL\\",
        r"C:\Users\noels\Downloads\DTL-main\DTL-main"
        "./",
        ""
    ]
...
with col2:
    st.image(r"C:\Users\noels\Downloads\DTL-main\DTL-main\Adobe Express - file.png", width=140)
